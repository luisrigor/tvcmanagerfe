...
const columnsInitial = [
  { name: 'calories', align: 'center', label: 'MÊS', field: 'calories' },
...
<template>
  ...
  >
    <span
      class="text-h7"
      style="padding-left: 5px; color: var(--brand-secondary)"
    >
      ...
      <div class="row">
        <div class="col-6">
          <q-select
            style="width: 250px"
            outlined
            v-model="dataProvisionReport.dataSelectProvisionReport.dealer"
        ...
        <div class="col-3">
          <q-select
            style="width: 200px"
            outlined
            v-model="dataProvisionReport.dataSelectProvisionReport.year"
            :options="dataOptionsStore.dataSelect.years"
            :label="dataProvisionReport.titles.labelYear"
          />
        </div>
        <!-- <div class="col-3">
                    <q-btn style="
